...
* The maximum line length for `npcap_sys` is 99, and is strictly enforced.
...
* Until constant functions can be defined in the minimum Rust that `npcap_sys` supports, if a function
